...
<head>
    ...
    <meta name="_csrf_parameter" content="_csrf" /><meta name="_csrf_header" content="X-CSRF-TOKEN" /><meta name="_csrf" content="f4d7fbb1-f175-4139-8fc8-69d27706980b" /><title>한솥도시락 > 로그인</title>
    ...
    <section class="login_page mo_version">
        ...
        <div class="login_wrap">
            <div class="login_formcont">
                ...
                <div>
<input type="hidden" name="_csrf" value="f4d7fbb1-f175-4139-8fc8-69d27706980b" />
</div></form><!-- //form -->
            </div>
        </div>
        <!-- //로그인 form -->
        ...
        <div class="join_select">
            ...
            <div class="join_formcont">
                ...
                <!-- btn -->
                <div class="btn_wrap">
                    <span class="btn btn_st02"><a href="./join.do" class="c_02">회원가입</a></span>
                </div>
                <!-- //btn -->
            </div>
        </div>
