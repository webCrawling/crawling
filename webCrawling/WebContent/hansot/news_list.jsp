...
<head>
    ...
    <meta name="_csrf_parameter" content="_csrf" /><meta name="_csrf_header" content="X-CSRF-TOKEN" /><meta name="_csrf" content="3686d4d2-3095-4d0a-b475-9e59503b5982" /><title>한솥 NEWS</title>
    ...
    <section class="news">
        ...
        <div class="news_wrap">
            ...
            <div class="ontitle">
                ...
                <form id="searchForm" name="searchForm" action="/hansot/news_list" method="get" onsubmit="return false;"><input type="hidden" id="pageNo" name="pageNo" value="1" />
