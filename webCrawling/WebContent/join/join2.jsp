...
<meta name="_csrf" content="81deaaae-2b7d-44da-9efe-a4177045ca77" />
...
<script async
	src="https://www.googletagmanager.com/gtag/js?id=UA-111772169-1"></script>
<script>
	...
	<div id="wrap" class="">
		...
		<div id="container" class="sub_page">
			...
			<div class="content join">
				<!--1depth-->
				<form action="joinCompleted.do" method="post"
					onsubmit="return validate();">
					<section class="join_step_03 mo_version">
						<!--2depth-->
						<!-- 회원가입_약관동의 -->
							...
							<div class="join_step_cont cont_st01">
								...
								<div class="join_sub">
									...
									<div class="join_form">
											...
											<dl class="in_box_th">
												...
												<dd>
													...
													<span class="form text"> <input type="text"
														id="memId" maxlength="20" name="memId"> <label
														for="memId">아이디를 입력해 주세요</label> <a href="#nome"
														class="btn_overlap" style="cursor: default; width: 100px">
															<input type="button"
															style="position: relative; color: #373737; font-size: 15px; bottom: 33px; width: 100px; height: 50px; background-color: rgba(255, 255, 255, 0); outline: 0; border: 0; cursor: pointer"
															onclick="confirming()" value="중복확인">
													</a>
													</span>
													<p class="result_comment true idResultTrue"
														style="display: none;">사용 가능한 아이디 입니다</p>
													<p class="result_comment false idResultFalse"
														style="display: none;">이미 등록된 아이디 입니다</p>
												</dd>
											</dl>
											<!-- 캡션 -->
											...
											<dl class="in_box_th">
												...
												<dd>
													...
													<span class="form text"> <input type="password"
														...
														for="newPassword">비밀번호를 입력해주세요</label>
													</span>
													<!--비밀번호-->
													<!--비밀번호 확인-->
													<span class="form text"> <input type="password"
														id="newPasswordRe" name="newPasswordRe"> <label
														for="newPasswordRe">비밀번호를 한번 더 입력해주세요</label>
													</span>
										...
										<div class="in_box">
											<dl class="in_box_th">
												...
												<dd>
													<span class="form text"> <input type="text"
														id="email" name="email" style="ime-mode: active">
										...
										<div class="in_box">
											<dl class="in_box_th">
												...
												<dd>
													<span class="form text"> <input type="text"
														id="phone" name="phone"> <label for="phone">핸드폰
															번호를 입력해주세요</label>
													</span>
												</dd>
											</dl>
									...
									<div class="ad_wrap">
										...
										<p class="ad_txt">이벤트 및 각종 할인 혜택에 대한 정보를 이메일/SMS 로
											수신하겠습니다. ※ 마케팅 활용 및 개인정보 보유 기간은 수신 거부 또는 회원 탈퇴시 까지입니다. 귀하는 수신
											동의를 거부하실 권리가 있으며, 동의를 거부하실 경우 정보 제공이 제한될 수 있습니다.</p>
									...
									<div class="btn_wrap">
										<span class="btn btn_st03"> <a href="#none"
											class="c_01"><button
													style="width: 150px; height: 30px; background-color: rgba(255, 255, 255, 0); outline: 0; border: 0"
													;type=submit id="input_01">가입하기</button></a>
									...
									<div>
										<input type="hidden" name="_csrf"
											value="81deaaae-2b7d-44da-9efe-a4177045ca77" />
									</div>
				</form>
				<form id="complateForm" name="complateForm"
					action="/join/join_step4" method="post">
			...
			<div class="ft_info_wrap">
				...
				<div class="ft_sns">
					...
					<a href="https://www.facebook.com/hansotOfficial/?ref=ts&fref=ts"
						target="_blank" class="sns_face_02" target="_blank" title="새 창 열림"><span
						class="blind">facebook</span></a>
				</div>
			</div>
			<!--// info -->
		</div>
